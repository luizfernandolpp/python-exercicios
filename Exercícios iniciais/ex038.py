# As três retas podem formar um triângulo? Se sim, qual o tipo do triângulo?
...
if soma1 > r3 and soma2 > r1 and soma3 > r2:
    ...
    if r1 == r2 and r1 == r3 and r2 == r3:
        print('O triângulo formado por elas é EQUILÁTERO.')
    elif r1 == r2 or r1 == r3 or r2 == r3:
        print('O triângulo formado por elas é ISÓSCELES.')
    else:
        print('O triângulo formado por elas é ESCALENO.')
else:
